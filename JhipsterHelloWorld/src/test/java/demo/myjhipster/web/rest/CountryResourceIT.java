...
import demo.myjhipster.domain.Country;
import demo.myjhipster.repository.CountryRepository;
...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).population(DEFAULT_POPULATION);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).population(UPDATED_POPULATION);
        return country;
    }
    ...
    void putNewCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).population(UPDATED_POPULATION);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).population(UPDATED_POPULATION);
